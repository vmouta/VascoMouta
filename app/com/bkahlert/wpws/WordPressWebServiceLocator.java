...
public class WordPressWebServiceLocator extends org.apache.axis.client.Service implements com.bkahlert.wpws.WordPressWebService {
    ...
    private java.lang.String WordPressWebServiceHttpSoapEndpoint_address = "http://blog.zucred.com/index.php?/wpws";
    ...
    public com.bkahlert.wpws.WordPressWebServicePortType getWordPressWebServiceHttpSoapEndpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bkahlert.wpws.WordPressWebServiceSoapBindingStub _stub = new com.bkahlert.wpws.WordPressWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bkahlert.wpws.WordPressWebServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bkahlert.wpws.WordPressWebServiceSoapBindingStub _stub = new com.bkahlert.wpws.WordPressWebServiceSoapBindingStub(new java.net.URL(WordPressWebServiceHttpSoapEndpoint_address), this);
                _stub.setPortName(getWordPressWebServiceHttpSoapEndpointWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://wpws.bkahlert.com", "WordPressWebService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://wpws.bkahlert.com", "WordPressWebServiceHttpSoapEndpoint"));
        }
